...
#### Test objective
 Verify get_name get the correct value
#### Test steps
* Call get_name, and verify it return the correct value

###  Test case #5 Platfform API is_leak
#### Test objective
 Verify is_leak get the correct value
#### Test steps
* Call is_leak, and verify it return the correct value

###  Test case #6 Platfform API get_leak_num
#### Test objective
 Verify get_leak_num get the correct value
#### Test steps
* Call get_leak_num, and verify it return the correct value
